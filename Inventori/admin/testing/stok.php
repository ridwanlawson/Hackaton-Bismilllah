...
// $totalz = mysql_fetch_array($totals);
                  $periksa=mysql_query("select barang_masuk.*, barang.id_brg, barang.nm_brg from barang_masuk, barang where sisa <=100 and barang_masuk.id_brg = barang.id_brg GROUP BY barang_masuk.id_brg, barang_masuk.letak_brg") or die(mysql_error());
                       ...
                       ?>
                        <div class="alert alert-danger alert-dismissible show fade">
                          <div class="alert-body">
                            ...
                            Jumlah <b><?php echo $q['nm_brg'] ?></b> Kurang dari <b>100</b> <?php echo $q['satuan'] ?>, Lakukan Pemesanan Barang! .
                          </div>
                        </div> 
                     <?php   }
                      }
