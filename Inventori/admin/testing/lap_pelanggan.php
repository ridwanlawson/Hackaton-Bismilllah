...
$pdf->Cell(4, 0.9, 'ID Pelanggan', 1, 0, 'C');
$pdf->Cell(7, 0.9, 'Nama Pelanggan', 1, 0, 'C');
...
while($lihat=mysql_fetch_array($query)){
	if ($lihat[0]<10) {
	    $lihatid = "PLG-00$lihat[0]";
	  }elseif ($lihat[0]<100){
	    $lihatid = "PLG-0$lihat[0]";
	  }else{
	  	$lihatid = "PLG-$lihat[0]";
	  }
	$pdf->Cell(1, 0.9, $no , 1, 0, 'C');
	$pdf->Cell(4, 0.9, $lihatid,1, 0, 'C');
	$pdf->Cell(7, 0.9, $lihat['nm_plg'], 1, 0,'C');
	$pdf->Cell(10, 0.9, $lihat['alamat'],1, 0, 'C');
	$pdf->Cell(3.5, 0.9, $lihat['telp'], 1, 1,'C');
