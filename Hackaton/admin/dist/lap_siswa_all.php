...
$no=1;
$query=mysqli_query($conn, "SELECT user.*, nilai.rata, nilai.nisn, biodata.nisn, biodata.nama, biodata.status, biodata.id FROM user, biodata, nilai WHERE biodata.nisn = nilai.nisn AND biodata.id = user.id ORDER BY biodata.status = 'Lulus'");
...
$pdf->Output("lap_siswa_all.pdf","I");
