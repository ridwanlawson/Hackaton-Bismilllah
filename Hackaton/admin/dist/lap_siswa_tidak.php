...
$pdf->Cell(25.5,0.7,"Laporan Data Siswa Tidak Lulus",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$no=1;
$query=mysqli_query($conn, "SELECT user.*, nilai.rata, nilai.nisn, biodata.nisn, biodata.nama, biodata.status, biodata.id FROM user, biodata, nilai WHERE biodata.nisn = nilai.nisn AND biodata.id = user.id AND biodata.status = 'tidak lulus'");
